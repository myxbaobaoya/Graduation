...
# # # 处理数据
# # data = np.array(train_temp)
# # all_y_trues = np.array(result_temp)
# #
...
# #     testPrice = np.apply_along_axis(network.feedforward, 1, data[i])
# #     print('test:',testPrice)
# # # 损失函数曲线图
...
# # print(data)
# # plt.plot(np.arange(200), all_y_trues,"r^")
# # plt.plot(np.arange(200),y_preds,"bs")
# #
